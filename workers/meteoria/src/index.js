...
export default {
  async fetch(request, env, ctx) {
    ...
    if (isAIBot(ua)) {
      try {
        const serveUrl = 'https://app.meteoria.ai/api/crawler-analytics/bot-content/serve?token=mt_50383f1a63144b65a0a09c507f7c7a17&path=' + encodeURIComponent(requestUrl.pathname);
...
async function forwardToMeteoria(request, requestUrl, ua, opts) {
  ...
  await fetch('https://app.meteoria.ai/api/crawler-analytics/server-track', {
    ...
    body: JSON.stringify({
      token: 'mt_50383f1a63144b65a0a09c507f7c7a17',
