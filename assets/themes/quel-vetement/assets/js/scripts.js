...
/* harmony import */ var jquery_cycle2__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! jquery.cycle2 */ "./node_modules/jquery.cycle2/src/jquery.cycle2.min.js");
/* harmony import */ var jquery_cycle2__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(jquery_cycle2__WEBPACK_IMPORTED_MODULE_1__);
...
(function ($) {
  scriptsMain = {
    /**
           ...
           */
    init: function init() {
      $(document).ready(scriptsMain.onReady);
      $(window).scroll(scriptsMain.onScroll);
      $(window).resize(scriptsMain.onResize);
      $(document).ready(scriptsMain.initSliderSimple);
    },
    ...
    onReady: function onReady() {
      ...
      $('.newsletter-overlay').click(function (e) {
        $('.newsletter-container').hide();
        $('.toggle-newsletter').removeClass('active');
        $('html, body').removeClass('noScroll');
      });
      $('.toggle-newsletter').click(function (e) {
        ...
        if ($('.toggle-newsletter').hasClass('active')) {
          $('html, body').addClass('noScroll');
        } else {
          $('html, body').removeClass('noScroll');
        }
      ...
      $('.gallery a[href$=".jpg"], .gallery a[href$=".jpeg"], .gallery a[href$=".png"], .gallery a[href$=".gif"]').attr('data-fancybox', 'gallery').fancybox({
        buttons: ['close'],
        infobar: false
      });
      $().fancybox({
      ...
      $('body').on('alnp-post-loaded', function (e, params) {
        ...
        sliderSimple.each(function () {
          ...
          owl.owlCarousel({
            ...
            items: 1,
            margin: 0,
            navText: ['<div class="btn btn-primary btn-effect"><span><i class="icon icon-chevron-up"></i></span><span>Previous</span></div>', '<div class="btn btn-primary btn-effect"><span><i class="icon icon-chevron-up"></i></span><span>Next</span></div>'],
    ...
    initSliderSimple: function initSliderSimple() {
      var sliderSimple = $('.gallery-type-slider');
      sliderSimple.each(function () {
        var container = this,
            owl = $('.owl-carousel', this);
...
/***/ 0:
/*!************************************************************************************!*\
  !*** multi ./src/js/scripts.js ./src/scss/style.scss ./src/scss/editor-style.scss ***!
  \************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
